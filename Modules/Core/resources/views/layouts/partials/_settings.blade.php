@php
    $route = request()->routeIs(['admin.settings', 'admin.email.index', 'admin.roles.index', 'admin.payment.index', 'admin.currency.index']);
@endphp
<li class="app-sidebar-menu-item">
    <a href="{{route('admin.settings')}}" class="menu-link d-flex align-items-center {{($route) ? 'menu-current' : ''}}">
        ...
        <span class="menu-title flex-grow-1">{{__('sidebar.settings')}}</span>
    </a>
</li>
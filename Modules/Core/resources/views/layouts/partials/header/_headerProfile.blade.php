<!-- User Options -->
@php
    $user_profile_picture = auth()->user()?->profile_picture == null ? asset('backend/assets/img/avatar/avatar-placeholder.jpg') : asset('storage/'.auth()->user()->profile_picture);
@endphp
...
<li class="header-nav-item header-user me-2">
    <a class="header-nav-link has-avater header-nav-link-toggle" href="javascript:void(0);" data-bs-toggle="dropdown">
        <img src="{{$user_profile_picture}}" alt="">

    ...
    <div class="app-sidebar-wrapper">
        ...
        <div id="app-sidebar-menu" class="app-sidebar-menu">
            <ul>
                ...
                <!-- page builder -->
                @include('core::layouts.partials._userManagement')

                <!-- page builder -->
                @include('core::layouts.partials._pageBuilder')
                ...
                <!-- Settings -->
                @include('core::layouts.partials._settings')

                <!-- User Profile -->
                @include('core::layouts.partials._userProfile')
            </ul>
        </div>

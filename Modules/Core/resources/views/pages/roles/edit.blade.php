                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.roles.update', ['id' => $role->id]) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <x-core::form.input type="text" id="roleName" name="name" value="{{ old('name', $role->name) }}" required/>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <div class="form-check mb-0 me-4 me-lg-12">
                                                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" {{ $role->hasPermissionTo($permission->name) ? "checked" : "" }} class="form-check-input" id="permission-{{ $permission->id }}">

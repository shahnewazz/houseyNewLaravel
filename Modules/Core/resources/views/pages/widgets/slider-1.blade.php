                        ...
                        <div class="repeater-lang-content">
                            ...
                            <div class="repeater-lang-tab @if ($code == $lang->code) active @endif" data-code="{{$lang->code}}">
                                <div class="mb-3">
                                    ...
                                    <x-core::form.input type="text" id="subtitle" name="widgets[widget-{{$id}}][widget_data][lang][{{$lang->code}}][subtitle]" value="{{ $data['lang'][$lang->code]['subtitle'] ?? '' }}" />
                                </div>
                                <div class="mb-3">
                                    <x-core::form.input-label :value="'Title '.$lang->code.''"/>
                                    <x-core::form.input type="text" id="title" name="widgets[widget-{{$id}}][widget_data][lang][{{$lang->code}}][title]" value="{{ $data['lang'][$lang->code]['title'] ?? '' }}" />
                                </div>
                                <div class="mb-3">
                                    <x-core::form.input-label :value="'Button Text '.$lang->code.' '"/>
                                    <x-core::form.input type="text" name="widgets[widget-{{$id}}][widget_data][button][lang][{{$lang->code}}][text]" value="{{ $data['button']['lang'][$lang->code]['text'] ?? '' }}" />
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="mb-3">
                                ...
                                <x-core::form.input type="text" name="widgets[widget-{{$id}}][widget_data][button][url]" value="{{ $data['button']['url'] ?? '' }}" />
                            </div>

<div class="card mb-5 widget-item" data-index="{{ $id }}">
    ...
    @php
        $item_count = @isset($data) ? count($data['repeater']) : 1;
                            ...
                            <div class="repeater-form-fields pb-4">
                                ...
                                <div class="repeater-form-wrapper">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="widgets[widget-{{$id}}][widget_data][repeater][repeater-item-{{$loop->iteration}}][title]" placeholder="Enter widget title" value="{{$item['title']}}">
                                    </div>

                                    @if ($code == 'en')
                                    <div class="mb-3">
                                        <label for="widget_image" class="form-label">Image</label>
                                        <input type="file" class="form-control" name="widgets[widget-{{$id}}][widget_data][repeater][repeater-item-{{$loop->iteration}}][image]">
                                    </div>                            
                                    @endif

                                    <div class="mb-3">
                                        <label for="widget_description" class="form-label">Description</label>
                                        <textarea class="form-control" name="widgets[widget-{{$id}}][widget_data][repeater][repeater-item-{{$loop->iteration}}][description]" rows="3" placeholder="Enter widget description"></textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    @else
                        ...
                        <div class="repeater-form-fields pb-4">
                            ...
                            <div class="repeater-form-wrapper">
                                <div class="mb-3">
                                    <label for="widget_title" class="form-label">Title</label>
                                    <input type="text" class="form-control" name="widgets[widget-{{$id}}][widget_data][repeater][repeater-item-1][title]" placeholder="Enter widget title">
                                </div>
                               @if ($code == 'en')
                                <div class="mb-3">
                                    <label for="widget_image" class="form-label">Image</label>
                                ...
                                <div class="mb-3">
                                    <label for="widget_description" class="form-label">Description</label>
                                    <textarea class="form-control" name="widgets[widget-{{$id}}][widget_data][repeater][repeater-item-1][description]" rows="3" placeholder="Enter widget description"></textarea>
                                </div>
                            </div>
                        </div>
                    @endisset

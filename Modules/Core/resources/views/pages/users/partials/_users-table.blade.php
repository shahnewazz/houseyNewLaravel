    ...
    <tr>
        ...
        <td>
            <div class="d-flex align-items-center">
                ...
                <a href="{{route('admin.users.edit', ['username' => $user->username])}}" class="btn btn-sm btn-icon btn-icon-secondary rounded-pill" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit">
                ...
                <form action="{{route('admin.users.destroy', ['username' => $user->username])}}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button class="btn btn-sm btn-icon btn-icon-secondary rounded-pill user-delete-btn" data-username={{$user->username}} type="button" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete">
